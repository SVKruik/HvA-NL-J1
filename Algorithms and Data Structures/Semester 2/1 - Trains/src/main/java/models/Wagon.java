...
public abstract class Wagon {
    ...
    // tail-connection-invariant: wagon.nextWagon == null or wagon ==
    // wagon.nextWagon.previousWagon
    // front-connection-invariant: wagon.previousWagon == null or wagon =
    // wagon.previousWagon.nextWagon
     ...
     * @throws IllegalStateException if this wagon already has a wagon appended to
     *                               it.
     * @throws IllegalStateException if tail is already attached to a wagon in front
     *                               of it.
     *                               The exception should include a message that
     *                               reports the conflicting connection,
    ...
    /**
     * Replaces the tail of the <code>front</code> wagon by this wagon and its
    ...
    public void reAttachTo(Wagon front) {
        // Unlink wagon from the sequence and re-attach the next wagon to the previous
        // wagon.
        front.detachTail();
        this.detachFront();
    ...
    /**
     * Reverses the order in the sequence of wagons from this Wagon until its final
     * successor.
     * The reversed sequence is attached again to the wagon in front of this Wagon,
     * if any.
     * No action if this Wagon has no succeeding next wagon attached.
     *
     * RELEVANT CODE USED IN REPORT
     *
     * @return the new start Wagon of the reversed sequence (with is the former last
     * Wagon of the original sequence)
     */
    public Wagon reverseSequence() {
        ...
        if (previousWagon != null)
            previousWagon.attachTail(previous);
    ...
    public boolean equals(Object object) {
        ...
        return id == wagon.id && Objects.equals(nextWagon, wagon.nextWagon)
                && Objects.equals(previousWagon, wagon.previousWagon);
    }
}

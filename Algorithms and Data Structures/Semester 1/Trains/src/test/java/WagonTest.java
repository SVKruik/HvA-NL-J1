...
public class WagonTest {
    ...
    @Test
    public void T02_APassengerWagonShouldHaveProperEquals() {
        var wagon1 = new PassengerWagon(9001, 16);
        var wagon1_Identical = new PassengerWagon(9001, 16);
        var wagon2_Different = new PassengerWagon(8001, 16);

        assertEquals(wagon1, wagon1, "Same object should be equal");
        // Equality by value
        assertEquals(wagon1, wagon1_Identical, "Identical object should be equal");
        assertNotEquals(wagon1, wagon2_Different, "Different objects should not be equal");
    }

...
<template>
    <nav class="shadow">
        ...
        <section class="personal-container">
            <span class="profile-picture shadow"
                :style="`background-image: url(${this.user ? this.user.avatar : null});`"
    ...
    <div class="dropdown-menu">
        ...
        <span class="splitter"></span>
        <div class="dropdown-item">
            <router-link to="/plans" v-if="this.user.edition === 'Basic'"
                class="dropdown-link-wrapper dropdown-link bold">

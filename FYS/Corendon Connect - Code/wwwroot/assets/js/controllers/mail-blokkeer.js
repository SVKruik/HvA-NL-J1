...
function mailBlokkeer(naam, adres) {
    FYSCloud.API.sendEmail({
        ...
        <div class="mail-content-container">
            ...
            <div class="mail-body">
                ...
                <p class="mail-main-text">Uw account is helaas geblokkeerd, en u kunt tijdelijk niet meer inloggen. Dit kan verschillende oorzaken hebben. Mocht u hier meer over willen weten, of denkt u dat deze actie onterecht is, aarzel dan niet om contact op te nemen met onze klantenservice. Wij helpen u graag verder.</p>

...
function mailMatch(naam, adres, verzender) {
    FYSCloud.API.sendEmail({
        ...
        <div class="mail-content-container">
            ...
            <div class="mail-body">
                ...
                <p class="mail-main-text">U heeft een nieuw match verzoek ontvangen van <strong>${verzender}</strong>. Ga naar de <a href="https://is110-3.fys.cloud/match.html">match</a> pagina en bekijk je nieuwe verzoek.</p>
